			...
			<section class="col-lg-8 col-lg-offset-2">
				...
				<form id="defaultForm" method="post" class="form-horizontal" action="<?php echo U('Admin/Login/login');?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class = "col-lg-3" >
                            <img class= "control-label" style="float:left;" id="code" src="<?php echo U('Admin/Login/verify');?>">
                    ...
                    <div class="form-group">
                        <div class="col-lg-9 col-lg-offset-3">
                            <button type="submit" class="btn btn-primary" name="signup" style="width:80px;">Login</button>
